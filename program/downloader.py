...
@Client.on_message(
    command(["/ابحثلي", f"vsong@{bn}", "/فيديو", f"video@{bn}"]) & ~filters.edited
)
async def vsong(client, message):
    ...
    try:
        ...
        print(e)
    try:
        msg = await message.reply(" جَاެࢪي اެݪبَحثَ...")
    ...
    await msg.edit("تَحَمَيَݪ اެݪمَݪفَ...")
